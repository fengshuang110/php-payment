 ...
 * 请求型接口的基类
 */
class Wxpay_client_pub extends Sdk
{
 ...
 * 响应型接口基类
 */
class Wxpay_server_pub extends Sdk
{
 ...
 * 静态链接二维码
 */
class NativeLink_pub  extends Sdk
{
